...
public class OrderRest {
	...
	if (orders != null) {
		 ArrayList<Order> listaPedidosClientes = orders.listaPedidosClientes(customer_id);
		    if (listaPedidosClientes != null) {
			respuesta = Response.status(Response.Status.OK).entity(listaPedidosClientes).build();
	    }
	}
	return respuesta;
    }
